...
const Dashboard = () => {
  return (
    <body>
      <div>
        <ul class="fixed top-36 left-16 group items-center w-full max-w-xs space-x-15 text-gray-500  divide-x divide-gray-200 rounded-lg shadow  dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800 ">
      ...
      <div id="default-carousel" class="relative w-[500px] m-auto mt-[20px]" data-carousel="static">
