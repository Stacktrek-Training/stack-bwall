...
const Feeds = () => {
  return (
    <>
      ...
      <h1 className=" mt-4 flex items-center justify-center text-xl font-bold leading-none text-orange-500  dark:text-white">Feeds</h1>

      <div className="h-full overflow-x-hidden w-full mt-4 border border-gray-400 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
