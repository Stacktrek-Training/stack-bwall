...
const Feeds = () => {
  return (
    <>
      ...
      <div
        class="mb-3 inline-flex w-full items-center rounded-lg bg-secondary-100 px-6 py-5 text-base text-secondary-800"
        role="alert"
      >
        <span class="mr-2">
          <svg
      ...
      <div
        class="mb-3 inline-flex w-full items-center rounded-lg bg-neutral-50 px-6 py-5 text-base text-neutral-600"
        role="alert"
      >
        <span class="mr-2">
          <svg
      ...
      <div
        class="mb-3 inline-flex w-full items-center rounded-lg bg-neutral-800 px-6 py-5 text-base text-neutral-50 dark:bg-neutral-900"
        role="alert"
      >
        <span class="mr-2">
          <svg
